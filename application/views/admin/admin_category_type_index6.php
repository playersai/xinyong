  ...
  <table cellspacing="1" class="mylist">
    ...
    <tr class="datalist <?php echo $a%2==0?"even":"odd"?>">
	 ...
	 echo $catval->sort;
      ...
      <td align="center" class="action">
	   <!--a href="/index.php/admin_vote/add/<?php echo $catval->cat_id; ?>">添加调查</a>
	   <a href="/index.php/admin_vote/<?php echo $catval->cat_id; ?>/1">调查管理</a-->
	  </td>
    </tr>
	...
	?>
	 ...
	 echo $sonsonval->sort;
	  ...
	  <a href="/index.php/admin_feedback/add/<?php echo $sonsonval->cat_id; ?>">添加留言反馈</a>
	   <a href="/index.php/admin_feedback/<?php echo $sonsonval->cat_id; ?>/1">留言反馈管理</a>
	  </td>
    </tr>
	<?php 
	}
