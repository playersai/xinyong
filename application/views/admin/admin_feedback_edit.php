...
<body>
<div class="wrap">
<form method="post" action="/index.php/admin_feedback/edit_handle/<?php echo $rows->f_id; ?>/<?php echo $selected_catid; ?>" class="ajax_form" name="myform" onsubmit="return checkdata()">
  <table cellspacing="1" class="myform">
    <tr>
      <th colspan="2">编辑留言反馈项目</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="title" maxlength="50" class="input" title="请输入标题，输入长度不能超过50个字符" value="<?php echo htmlspecialchars($rows->title); ?>" style="width:360px;" /></td>
    </tr>
	...
	<tr>
      ...
      <td><input class="Wdate" type="text" onClick="WdatePicker()" name="start_time" title="请输入开始时间" value="<?php echo date("Y-m-d",$rows->start_time); ?>" style="width:360px;" readonly/> </td>
    </tr>
    
	<tr>
      <td align="right"><font color="red">*&nbsp;</font>结束时间：</td>
      <td><input class="Wdate" type="text" onClick="WdatePicker()" name="exp_time" title="请输入结束时间" value="<?php echo date("Y-m-d",$rows->exp_time); ?>" style="width:360px;" readonly/> </td>
    </tr>
    
    <tr>
      <td align="right">项目介绍：</td>
      <td>
	    <textarea name="content1" style="width:700px;height:390px;visibility:hidden;"><?php echo $rows->content; ?></textarea>
	  </td>
    </tr>
