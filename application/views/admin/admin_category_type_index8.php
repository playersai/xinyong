...
<div class="wrap">
  ...
  <table cellspacing="1" class="mylist">
    ...
    <tbody>
    <?php if(is_array($cat) and isset($cat['parent'])){
	$a=0;
    ...
    <tr class="datalist <?php echo $a%2==0?"even":"odd"?>">
	 ...
	 echo $catval->sort;
      ...
      <td align="center" class="action">
	   ...
	   <a class="win_normal" href="/index.php/admin_category/add/<?php echo $catval->cat_id; ?>/<?php echo $catval->cat_type_id; ?>" title="添加子分类"><strong>添加分类</strong></a>
	  
	  <a class="win_normal" href="/index.php/admin_category/edit2/<?php echo $catval->cat_id; ?>/<?php echo $catval->cat_type_id; ?>" title="编辑分类"><strong>编辑分类</strong></a>
	  </td>
    </tr>
	...
	<?php if(@is_array($cat['son'][$sonval->cat_id])){
	...
	?>
	 ...
	 echo $sonsonval->sort;
	  ...
	  <a href="/index.php/admin_ads/add/<?php echo $sonsonval->cat_id; ?>">添加广告</a>
	   <a href="/index.php/admin_ads/<?php echo $sonsonval->cat_id; ?>/1">广告管理</a>
	  </td>
    </tr>
	<?php 
	}
