...
<body>
<div class="wrap">
<form method="post" name="myform" action="/index.php/admin_ads/edit_handle/<?php echo $rows->ads_id; ?>/<?php echo $selected_catid; ?>/<?php echo $rows->status; ?>" class="ajax_form" onsubmit="return checkdata()">
  <table cellspacing="1" class="myform">
    ...
    <tr>
      ...
      <td>
        <input type="text" name="link" maxlength="255" class="input" dataType="require" title="请输入广告链接地址，输入长度不能超过255个字符" value="<?php echo $rows->link; ?>" style="width:360px;" />
      </td>
    </tr>
	 ...
	 <tr>
      ...
      <td>
        <input type="text" name="thumb" maxlength="255" class="input" dataType="require" title="请上传广告图片或输入广告图片地址，输入长度不能超过255个字符" value="<?php echo $rows->thumb; ?>" style="width:300px;float:left;" />
    ...
    <tr>
      ...
      <td>
	    <textarea name="content" maxlength="200" cols="65" rows="8" title="请输入广告介绍，输入长度不能超过200个字符"><?php echo $rows->content; ?></textarea>
      </td>
    </tr>
	...
	<tr>
      ...
      <td>
        <input type="text" name="sort" maxlength="8" value="<?php echo $rows->sort; ?>" size="8" >
    ...
    <tr>
      ...
      <td>
        <input type="radio" name="status" value="1" style="vertical-align: middle;margin-right:3px;"<?php if($rows->status=='1') echo 'checked';?>>
        <label>显示</label> &nbsp;&nbsp;<input type="radio" name="status" value="0" style="vertical-align: middle;margin-right:3px;" <?php if($rows->status=='0') echo 'checked';?> ><label>待审</label>
