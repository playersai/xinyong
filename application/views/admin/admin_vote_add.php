...
<form method="post" action="/index.php/admin_vote/add_handle/" class="ajax_form" name="myform" onsubmit="return checkdata()">
  <table cellspacing="1" class="myform">
	...
	<tr>
      ...
      <td><input name="start_time" class="Wdate" type="text" onClick="WdatePicker()" title="请输入开始时间" value="" style="width:360px;" /> </td>
    </tr>
	<tr>
      <td align="right"><font color="red">*&nbsp;</font>结束时间：</td>
      <td><input  name="exp_time" class="Wdate" type="text" onClick="WdatePicker()" title="请输入结束时间" value="" style="width:360px;" /> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="sort" size="6" class="input" value="0" /></td>
    </tr>
