  ...
  <table cellspacing="1" class="mylist">
	...
	?>
	 ...
	 echo $sonsonval->sort;
	  ...
	  ?></td>
      <td align="center" class="action"><a href="/index.php/admin_vote/add/<?php echo $sonsonval->cat_id; ?>">添加调查</a>
	   <a href="/index.php/admin_vote/<?php echo $sonsonval->cat_id; ?>/1">调查管理</a>
	  </td>
    </tr>
	<?php 
	}
