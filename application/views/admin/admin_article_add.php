...
<body>
<div class="wrap">
<form method="post" action="/index.php/admin_article/add_handle/" class="ajax_form" name="myform" onsubmit="return checkdata()">
  <table cellspacing="1" class="myform">
    ...
    <tr>
      ...
      <td><input type="text" name="title" class="input" maxlength="50" dataType="require" title="请输入文章标题，输入长度不能超过50个字符" value="" style="width:360px;" /></td>
    </tr>
    ...
    <tr>
      ...
      <td><input type="text" name="afrom" class="input" maxlength="20" dataType="require" title="请输入来源，输入长度不能超过20个字符" value="<?php echo $_SESSION['group_name'];?>" style="width:360px;" /> </td>
    </tr>
    
	<tr>
      <td align="right">作者：</td>
      <td><input type="text" name="author" class="input" maxlength="20" dataType="require" title="请输入作者，输入长度不能超过20个字符" value="" style="width:360px;" /> </td>
    </tr>
    
    <tr>
      <td align="right">缩略图：</td>
      <td>
        <input type="text" name="thumb" class="input" dataType="require" title="请上传缩略图或输入缩略图地址" value="" style="width:360px;" />
	...
	<tr>
      ...
      <td>
        <!-- <input type="checkbox" name="settop" value="1" style="vertical-align: middle;margin-right:3px;" ><label>置顶</label>
 	    &nbsp;&nbsp; -->
	    <input type="checkbox" name="index_top"  value="1" style="vertical-align: middle;margin-right:3px;"><label>首页头条</label>
	  </td>
    </tr>
    <?php endif; ?>
	...
	<tr>
      ...
      <td>
        <input type="checkbox" name="is_redirect" value="1" class="input" style="vertical-align: middle;margin-right:3px;" ><label>启用</label>
	    <input type="text" name="redirect_url" size="50" class="input" value="" title="请输入转向连接URL地址"/>&nbsp;<font color="red">启用后将直接跳转到指定地址（发布内容不显示）</font></td>
    </tr>
    
    <tr>
      <td align="right"><font color="red">*&nbsp;</font>排序：</td>
      <td><input type="text" name="sort" maxlength="8" size="6" class="input" value="0" /></td>
    </tr>
