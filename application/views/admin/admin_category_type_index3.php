  ...
  <table cellspacing="1" class="mylist">
    ...
    <tr class="datalist <?php echo $a%2==0?"even":"odd"?>">
	 ...
	 echo $catval->sort;
      ...
      <td align="center" class="action">
	   <!--a href="/index.php/admin_photo/add/<?php echo $catval->cat_id; ?>">添加图片集</a>
	   <a href="/index.php/admin_photo/<?php echo $catval->cat_id; ?>/1">图片集管理</a-->
	  </td>
    </tr>
	...
	?>
	 ...
	 echo $sonsonval->sort;
	  ...
	  ?></td>
      <td align="center" class="action"><a href="/index.php/admin_photo/add/<?php echo $sonsonval->cat_id; ?>">添加图片集</a>
	   <a href="/index.php/admin_photo/<?php echo $sonsonval->cat_id; ?>/1">图片集管理</a>
	  </td>
    </tr>
	<?php 
	}
