...
<div class="wrap">
  ...
  <table cellspacing="1" class="mylist">
    ...
    <tr class="mylist_title">
      ...
      <td width="108">单页名称</td>
      <td width="398">单页简介</td>
	  <td width="52">单页属性</td>
	  <td width="52">排 序</td>
      <td width="52">状 态</td>
      <td width="122">操 作</td>
    ...
    <tr class="datalist <?php echo $a%2==0?"even":"odd"?>">
	 ...
	 echo $catval->sort;
	  ...
	  <a class="win_normal" href="/index.php/admin_category/edit<?php echo $catval->cat_type_id; ?>/<?php echo $catval->cat_id; ?>" title="编辑单页"><img src="/public/manage/images/edit.gif" alt="编辑单页" width="16" height="16" /></a>
	  
	  <a class="win_normal" href="/index.php/admin_category/delete/<?php echo $catval->cat_id; ?>/<?php echo $catval->status; ?>" title="<?php echo $catval->status=='0'?'还原单页':'删除单页'; ?>"><img src="/public/manage/images/delete.gif" alt="<?php echo $catval->status=='0'?'还原单页':'删除单页'; ?>" width="16" height="16" /></a>
	  </td>
    </tr>
	 ...
	 echo $sonval->sort;
	  ...
	  <a class="win_normal" href="/index.php/admin_category/edit<?php echo $sonval->cat_type_id; ?>/<?php echo $sonval->cat_id; ?>" title="编辑单页"><img src="/public/manage/images/edit.gif" alt="编辑单页" width="16" height="16" /></a>
	  
	  <a class="win_normal" href="/index.php/admin_category/delete/<?php echo $sonval->cat_id; ?>/<?php echo $sonval->status; ?>" title="<?php echo $sonval->status=='0'?'还原单页':'删除单页'; ?>"><img src="/public/manage/images/delete.gif" alt="删除单页" width="16" height="16" /></a>
	...
	?>
	 ...
	 echo $sonsonval->sort;
	  ...
	  ?></td>
      <td align="center" class="action">
	  <a class="win_normal" href="/index.php/admin_category/edit<?php echo $sonsonval->cat_type_id; ?>/<?php echo $sonsonval->cat_id; ?>" title="编辑单页"><img src="/public/manage/images/edit.gif" alt="编辑单页" width="16" height="16" /></a>
	  
	  <a class="win_normal" href="/index.php/admin_category/delete/<?php echo $sonsonval->cat_id; ?>/<?php echo $sonsonval->status; ?>" title="<?php echo $sonsonval->status=='0'?'还原单页':'删除单页'; ?>"><img src="/public/manage/images/delete.gif" alt="删除单页" width="16" height="16" /></a>
	  </td>
    </tr>
	<?php 
	}
