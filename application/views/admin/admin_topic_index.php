	...
	$(document).ready(function() { 
		$("#delete_arr").click(function() { 
			var delete_arr='';
				...
				if(confirm('确定要删除这些项目吗？删除后将不能还原！')){
				 ...
				 if(delete_arr!=''){
						window.location.href="/index.php/admin_topic/delete_arr/"+delete_arr;
				   }else{	
					  alert("请选择要删除的项目！");
				   }  
		...
		$("#status_arr_1").click(function() { 
			var status_arr='';
				...
				if(confirm('确定要这些项目显示吗？')){
				  ...
				  if(status_arr!=''){
						window.location.href="/index.php/admin_topic/status_arr/"+status_arr+"/1";
				   }else{
					  alert("请选择要显示的项目！");
				   }	
		...
		$("#status_arr_0").click(function() { 
			var status_arr='';
			   ...
			   if(status_arr!=''){	 
				   window.location.href="/index.php/admin_topic/status_arr/"+status_arr+"/0";		   
			   }else{
				  alert("请选择要待审的项目！");
			   }	
			   }
...
<div class="wrap">
  ...
  <table cellspacing="1" class="mylist">
    ...
    <tr>
      <th colspan="9">
      <div class="relative">[<?php echo is_array($crows)?$crows[0]->name:'';?>] 专题列表
        <div class="buttons">
		    ...
		    <a class="_add blue" href="javascript:void(0);" title="批量删除" id='delete_arr'>
             ...
             <a class="_add blue" href="/index.php/admin_topic/add/<?php echo is_array($crows)?$crows[0]->cat_id:'';?>" title="新增">
      ...
      <div class="search">
        ...
        <script>
          ...
          $("#btn_search").click(function() { 
	          ...
	          window.location.href="/index.php/admin_topic/index/<?php echo $id.'/' ;?>" + queryStr + "/<?php echo $per_pages ;?>";
          });
    ...
    <tr class="datalist">
      ...
      <td><?php echo $aval->title; ?><?if($aval->settop==1) echo '<font color="red">[置顶]</font>';?><?if($aval->index_top==1) echo '<font color="red">&nbsp;[首页头条]</font>';?></td>
      ...
      <td align="center" class="action">
	    <a class="win_normal" href="/index.php/admin_topic/add_thumb/<?php echo $aval->aid; ?>/<?php echo $aval->cat_id; ?>" title="添加图集"><img src="/public/manage/images/add.gif" alt="添加图集" width="16" height="16"></a>
	    <a class="win_normal" href="/index.php/admin_topic/edit/<?php echo $aval->aid; ?>/<?php echo $aval->cat_id; ?>" title="编辑"><img src="/public/manage/images/edit.gif" alt="编辑" width="16" height="16" /></a>
	    <a class="win_normal" href="/index.php/admin_topic/delete/<?php echo $aval->aid; ?>" title="删除" onclick="javascript:return confirm('确定要删除本项目吗？删除后将不能还原！')"><img src="/public/manage/images/delete.gif" alt="<?php echo $aval->status=='0'?'还原':'删除'; ?>" width="16" height="16" /></a>
	  </td>
    </tr>
    <?php } ?>
    </tbody>
