...
<body>
<div class="wrap">
<form name="myform" method="post" action="/index.php/admin_photo/edit_handle/<?php echo $rows->photo_id; ?>/<?php echo $rows->cat_id; ?>/<?php echo $rows->status; ?>" class="ajax_form" onsubmit="return checkdata()">
  <table cellspacing="1" class="myform">
    <tr>
      <th colspan="2">编辑图片集</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <input type="text" name="thumb" class="input" dataType="require" title="请上传封面图或输入封面图地址" value="<?php echo $rows->first_thumb; ?>" style="width:300px;" />
    ...
    <tr>
      ...
      <td>
	    <textarea name="content1" style="width:700px;height:290px;visibility:hidden;"><?php echo $rows->content; ?></textarea>
      </td>
    </tr>
      ...
      <td>
	    ...
	    <dl style="width:150px;float:left;margin:10px;border:#ddd dashed 1px;text-align:center">
	      ...
	      <dt style="padding-top:6px;">  
	        <a class="win_normal" href="/index.php/admin_photo/edit_thumb/<?php echo $tval->thumb_id; ?>" title="编辑"><img src="/public/manage/images/edit.gif" alt="编辑" width="16" height="16" /></a>
	...
	<tr>
      ...
      <td style="height:300px;"><p style="color:red">为了保证浏览效果，建议图片尺寸大于640 x 480 px</p>
		<ul id="xx">
	...
	<tr>
      ...
      <td>
	    ...
	    &nbsp;&nbsp;
	    <input type="checkbox" name="index_top"  value="1"  style="vertical-align: middle;margin-right:3px;" <?php  if($rows->index_top =='1') echo 'checked'; ?>><label>首页显示</label> -->
	    <input type="text" name="sorter" maxlength="8" size="6" class="input" value="<?php echo $rows->sorter; ?>" />
	  </td>
    </tr>
