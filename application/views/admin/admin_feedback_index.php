	...
	$(document).ready(function() { 
		$("#delete_arr").click(function() { 
			var delete_arr='';
				...
				if(confirm('确定要删除这些项目吗？删除后将不能还原！')){
				 ...
				 if(delete_arr!=''){
						window.location.href="/index.php/admin_feedback/delete_arr/"+delete_arr;
				   }else{	
					  alert("请选择要删除的项目！");
				   }  
		...
		$("#status_arr_1").click(function() { 
			var status_arr='';
				...
				if(confirm('确定要这些项目显示吗？')){
				  ...
				  if(status_arr!=''){
						window.location.href="/index.php/admin_feedback/status_arr/"+status_arr+"/1";
				   }else{
					  alert("请选择要显示的项目！");
				   }	
		...
		$("#status_arr_0").click(function() { 
			var status_arr='';
			   ...
			   if(status_arr!=''){	 
				   window.location.href="/index.php/admin_feedback/status_arr/"+status_arr+"/0";		   
			   }else{
				  alert("请选择要待审的项目！");
			   }	
			   }
...
<div class="wrap">
  ...
  <table cellspacing="1" class="mylist">
    ...
    <tr>
      ...
      <div class="relative">[<?php echo $crows[0]->name; ?>] 列表
        <div class="buttons">
          ...
          <a class="_add blue" href="/index.php/admin_feedback/add/<?php echo $crows[0]->cat_id; ?>" title="新增">
      ...
      <div class="search">
        ...
        <script>
          ...
          $("#btn_search").click(function() { 
	          ...
	          window.location.href="/index.php/admin_feedback/index/<?php echo $id.'/' ;?>" + queryStr + "/<?php echo $per_pages ;?>";
          });
    ...
    <tr class="datalist">
      <td align="center"><input type="checkbox" value="<?php echo  $aval->f_id; ?>" class="delete_a" /></td>
      ...
      <td align="center" class="action">
	    <a class="win_normal" href="/index.php/admin_feedback/result_list/37/<?php echo $aval->f_id; ?>"><img src="/public/manage/images/view.gif"  alt="查看调查结果" width="16" height="16" title="查看调查结果"></a>
	    <a class="win_normal" href="/index.php/admin_feedback/edit/<?php echo $aval->f_id; ?>/<?php echo $aval->cat_id; ?>" title="编辑"><img src="/public/manage/images/edit.gif" alt="编辑" width="16" height="16" /></a>
	    <a class="win_normal" href="/index.php/admin_feedback/delete/<?php echo $aval->f_id; ?>" onclick="javascript:return confirm('确定要删除本项目吗？删除后将不能还原！')" title="删除" ><img src="/public/manage/images/delete.gif" alt="<?php echo $aval->status=='0'?'还原':'删除'; ?>" width="16" height="16" /></a>
	  </td>
    </tr>
    <?php } ?>
    </tbody>
