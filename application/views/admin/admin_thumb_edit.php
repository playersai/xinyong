...
<body>
<div class="wrap">
<form name="myform" method="post" action="/index.php/admin_photo/edit_thumb/<?php echo $rows->thumb_id; ?>" class="ajax_form" >
  <table cellspacing="1" class="myform">
   ...
   <tr>
      ...
      <td> 
	  <input type="text" name="f_link" size="30" value="<?php echo $rows->f_link; ?>" > <font color="red">如果不为空，跳转到新该链接</font>
	  </td>
    </tr>
	<tr>
