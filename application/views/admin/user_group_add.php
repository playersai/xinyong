...
<body>
<div class="wrap">
<form name="myform" method="post" action="<?php echo admin_url('admin_user_group/add_handle'); ?>" class="ajax_form" onsubmit="return checkdata()">
  <table cellspacing="1" class="myform">
	<tr>
	  <th colspan="2">新增用户组</th>
	</tr>
	<tr>
	  <td align="right"><font color="#FF0000">*&nbsp;</font>用户组名称：</td>
	  <td>
		<input type="text" name="name" style="width:260px;" class="input" maxlength="20" dataType="require" title="请输入用户组名称" /> 
	...
	<tr>
	  ...
	  <td>
		<input type="text" name="description" style="width:260px;" class="input" maxlength="20" dataType="require" title="请输入组描述" /> 
	...
	<tr>
	  ...
	  <td>
		<input type="radio" name="status" value="1" style="vertical-align: middle;margin-right:3px;" checked><label>开启</label>
		<input type="radio" name="status" value="0" style="vertical-align: middle;margin-right:3px;"><label>禁用</label>
	  </td>
	</tr>
	<tr>
	  <td align="right"></td>
