...
<body>
<div class="wrap">
<form method="post" action="/index.php/admin_feedback/add_handle/<?php echo $selected_catid; ?>" class="ajax_form" name="myform" onsubmit="return checkdata()">
  <table cellspacing="1" class="myform">
    <tr>
      <th colspan="2">添加留言反馈项目</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="title" maxlength="50" class="input" dataType="require" title="请输入标题，输入长度不能超过50个字符" value="" style="width:360px;" /></td>
    </tr>
	...
	<tr>
      ...
      <td><input class="Wdate" type="text" onClick="WdatePicker()" name="start_time" title="请输入开始时间" value="" style="width:360px;" readonly/> </td>
    </tr>
    
	<tr>
      <td align="right"><font color="red">*&nbsp;</font>结束时间：</td>
      <td><input class="Wdate" type="text" onClick="WdatePicker()" name="exp_time" title="请输入结束时间" value="" style="width:360px;" readonly/> </td>
    </tr>
	...
	<tr>
      ...
      <td>
        <input type="text" name="sort" maxlength="8" size="6" class="input" value="0" />
	  </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <input type="radio" name="status" value="1" style="vertical-align: middle;margin-right:3px;" checked><label>显示</label> 
