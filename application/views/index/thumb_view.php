  ...
  &gt;&gt; <a href="/index.php/category/<?php echo $nav_location[2]->cat_id.'/'.$nav_location[2]->parent_id; ?>"><?php echo $nav_location[2]->name; ?></a>
  &gt;&gt; <span class="active"><?php echo htmlspecialchars($photo_info->title); ?> </span>
  </div>
  <!--breadcrumb end-->
