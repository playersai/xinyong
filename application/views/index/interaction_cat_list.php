  ...
  <span class="active"><?php echo $left_navs[$left_navs_selected][0]['name']; ?></span>
  </div>
  <!--breadcrumb end-->
  <div class="clear"></div>
  <div class="left_side">
 ...
 <div class="right_side">
    <div class="news_list2">
      <ul class="tab_conbox">
        <li class="tab_con"><?php
		if(isset($fbrows) and is_array($fbrows)){
		foreach($fbrows as $fbval){
		?>
        <span><font><?php echo date("Y-m-d",$fbval->addtime);?></font><a href=""><?php echo $fbval->title;?></a></span>
