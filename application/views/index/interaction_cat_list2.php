    ...
    <div class="news_list2">
      <ul class="tab_conbox">
        <li class="tab_con">
          ...
          <span><font><?php echo date("Y-m-d",$fbval->addtime);?></font><a href="/index.php/interaction/article/<?php echo $fbval->aid.'/'.$fbval->cat_id;?>" target="_blank"><?php echo htmlspecialchars($fbval->title);?></a></span>
		  <?php } ?>
        <div class="clear"></div>
        <div class="page">
