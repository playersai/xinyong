...
<title>中国中小商业企业协会-信用专委会</title>
 
<link href="/public/index/css/css_index.css" rel="stylesheet" type="text/css" media="screen" />
<link href="/public/index/css/article_news.css" rel="stylesheet" type="text/css" media="screen" /> 
...
.sousuo{ height:32px; no-repeat 0 center;}
...
<DIV class="text"><IMG  alt="" src="imageszhong/2014022810035113.gif"></DIV>-->
  ...
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="1000" height="115">
          ...
          <embed src="/public/index/css/imageszhong/信用专委会.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="1000" height="115"></embed>
</object>
...
<DIV class="navBar">
    <ul>
      ...
      <li><a href="<?php echo $navs_url[$nkey]; ?>" <?php if($nkey==$nav_selected){echo 'class="navHeader"';}?>><span><?php echo $nval; ?></span><i> </i></a></li>
      <?php if($nkey + 1 != count($navs)): ?><li> </li><?php endif; ?>
	  <?php } ?>
