 ...
 <div class="right_side">
    <div class="news_list2">
      <ul class="tab_conbox">
        ...
        <span><font><?php echo date("Y-m-d",$fbval->addtime);?></font><a href="/index.php/interaction/feedback/<?php echo $fbval->f_id.'/'.$fbval->cat_id;?>" target="_blank"><?php echo htmlspecialchars($fbval->title);?></a></span>
		<?php } ?>
        <div class="clear"></div>
        <div class="page">
