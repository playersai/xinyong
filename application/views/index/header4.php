    ...
    <div class="head_banner">
      <div id="full-screen-slider">
          <ul id="slides">
		    ...
		    <li style="background:url('/public/attached/thumb/20141226/7.png') no-repeat right top;background-size:800px 148px; width:800px; height:148px;"><a href="<?php echo $topval->link; ?>"></a></li>
